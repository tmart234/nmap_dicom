...
author = "Paulino Calderon <calderon()calderonpale.com> and Tyler Martin"
...
Driver = {
  ...
  login = function(self, username, password)
    ...
    if dcm_conn then
      -- Register the discovered AET for other scripts to use
      dicom.register_aet(self.host, self.port, password)
